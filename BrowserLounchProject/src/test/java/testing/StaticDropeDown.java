...
public class StaticDropeDown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"//div [@id='ctl00_mainContent_ddl_destinationStation1_CTNR']//a[@text='Thiruvananthapuram (TRV)']"))
				.click();
		 ...
		 * 
		 * for(int s=1;s<5;s++) { driver.findElement(By.xpath(
		 * "//div[@data-testid='Children-testID-plus-one-cta']")).click();
		 * System.out.println(driver.findElement(By.xpath(
		 * "//div[@data-testid='Adult-testID-plus-one-cta']")).getText()); }
		 * driver.findElement(By.xpath(
		 * "//div[@data-testid='home-page-travellers-done-cta']")).click();
		 */
		WebElement CurrencyDropdown = driver
